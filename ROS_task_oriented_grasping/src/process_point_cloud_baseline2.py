...
<<<<<<< HEAD
               print('x_dim smaller than gripper width tolerance! ')
=======
>>>>>>> b6641299b1b791cecfab931ada1b5c90f71e07a9
...
<<<<<<< HEAD
                  print('Approach direction 2 valid: ')
=======
>>>>>>> b6641299b1b791cecfab931ada1b5c90f71e07a9
                  # print('Unit Vector U1 Before: ', self.unit_u1)
                  self.unit_u1 -= self.unit_u1.dot(self.z_C1)*self.z_C1
                  self.unit_u1 /= la.norm(self.unit_u1)
                  # print('Unit Vector U1: ', self.unit_u1)
...
<<<<<<< HEAD
               ...
               if self.distance_2 < self.gripper_height_tolerance: 
                  print('Approach direction 1 valid: ')
=======
               else:
                  continue
               ...
               if self.distance_2 < self.gripper_height_tolerance: 
>>>>>>> b6641299b1b791cecfab931ada1b5c90f71e07a9
                  #print('Unit Vector U2 Before: ', self.unit_u2)
                  self.unit_u2 -= self.unit_u2.dot(self.z_C1)*self.z_C1
                  self.unit_u2 /= la.norm(self.unit_u2)
                  # print('Unit Vector U2: ', self.unit_u2)
                  # End Effector Orientation Based on the Franka Panda Convention: 
...
<<<<<<< HEAD
               ...
               if self.distance_3 < self.gripper_height_tolerance: 
                  print('Approach direction 4 valid: ')
=======
               else:
                  continue
               ...
               if self.distance_3 < self.gripper_height_tolerance: 
>>>>>>> b6641299b1b791cecfab931ada1b5c90f71e07a9
                  self.unit_u3 -= self.unit_u3.dot(self.z_C1)*self.z_C1
                  self.unit_u3 /= la.norm(self.unit_u3)
                  # print('Unit Vector U3: ', self.unit_u3)
                  # End Effector Orientation Based on the Franka Panda Convention: 
...
<<<<<<< HEAD
               print('y_dim smaller than gripper width tolerance! ')
=======
>>>>>>> b6641299b1b791cecfab931ada1b5c90f71e07a9
               # Orientation of the contact reference frames: 
               # Getting an orthogonal reference frame where the z axis is along the normal: 
...
<<<<<<< HEAD
               ...
               if self.distance_2 < self.gripper_height_tolerance: 
                  print('Approach direction 3 valid: ')
                  self.unit_u2 -= self.unit_u2.dot(self.z_C1)*self.z_C1
                  self.unit_u2 /= la.norm(self.unit_u2)
                  # End Effector Orientation Based on the Franka Panda Convention: 
                  self.z_EE = self.unit_u2
...
<<<<<<< HEAD
               ...
               if self.distance_3 < self.gripper_height_tolerance: 
                  print('Approach direction 5 valid: ')
                  self.unit_u3 -= self.unit_u3.dot(self.z_C1)*self.z_C1
                  self.unit_u3 /= la.norm(self.unit_u3)
                  # End Effector Orientation Based on the Franka Panda Convention: 
                  self.z_EE = self.unit_u3
