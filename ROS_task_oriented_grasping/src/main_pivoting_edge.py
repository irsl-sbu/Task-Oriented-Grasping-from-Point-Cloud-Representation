...
if __name__ == "__main__":
    ...
    o3d.io.write_point_cloud("cdominosugar_pivoting_edge_pose3_EE1_segmented.ply", objectCloud)
    ...
    cloud_object.point = np.asarray([np.divide((cloud_object.transformed_vertices_object_frame[1,0] + cloud_object.transformed_vertices_object_frame[0,0]),2), cloud_object.transformed_vertices_object_frame[1,1], cloud_object.transformed_vertices_object_frame[1,2]])
    cloud_object.moment = np.cross(cloud_object.point, cloud_object.screw_axis)'''

    '''cloud_object.screw_axis = np.asarray([-1, 0, 0])
    cloud_object.point = np.asarray([np.divide((cloud_object.transformed_vertices_object_frame[7,0] + cloud_object.transformed_vertices_object_frame[2,0]),2), cloud_object.transformed_vertices_object_frame[2,1], cloud_object.transformed_vertices_object_frame[2,2]])
    cloud_object.moment = np.cross(cloud_object.point, cloud_object.screw_axis)'''
    ...
    np.savetxt("cdominosugar_pivoting_edge_pose3_EE1_object_frame.csv", cloud_object.transformed_points_object_frame, delimiter= ",")
    o3d.io.write_point_cloud("dominosugar_pivoting_edge_pose3_EE1_segmented.ply", cloud_object.cloud_object_frame)
    ...
    np.savetxt('dominosugar_pivoting_edge_pose3_EE1_pre_grasp_poses_object_frame_alg1.csv', pre_grasp_poses_object_frame, delimiter=",")
    np.savetxt('dominosugar_pivoting_edge_pose3_EE1_grasp_poses_object_frame_alg1.csv', grasp_poses_object_frame, delimiter=",")

    np.savetxt('dominosugar_pivoting_edge_pose3_EE1_pre_grasp_poses_base_frame_alg1.csv', pre_grasp_poses_base_frame, delimiter=",")
    np.savetxt('dominosugar_pivoting_edge_pose3_EE1_grasp_poses_base_frame_alg1.csv', grasp_poses_base_frame, delimiter=",")

    # Saving the screw axis and point as expressed in the object reference frame:
    np.savetxt('dominosugar_pivoting_edge_pose3_EE1_screw_axis_object_frame_alg1.csv', cloud_object.screw_axis, delimiter = ',')
    np.savetxt('dominosugar_pivoting_edge_pose3_EE1_point_object_frame_alg1.csv', cloud_object.point, delimiter = ',')

    # Saving the pose of the object with respect to the base frame:
    np.savetxt('dominosugar_pivoting_edge_pose3_EE1_R_object_alg1.csv', cloud_object.R_bounding_box, delimiter = ',')
    np.savetxt('dominosugar_pivoting_edge_pose3_EE1_p_object_alg1.csv', cloud_object.p_bounding_box, delimiter = ',')

    # Saving the desired final pose as well:
    np.savetxt('dominosugar_pivoting_edge_pose3_EE1_desired_grasp_pose_final_alg1.csv', desired_grasp_pose_base_frame_final)
