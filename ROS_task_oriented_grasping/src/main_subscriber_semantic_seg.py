...
if __name__ == '__main__':
    ...
    # np.savetxt("dataPointsSegmented_cheezit_trial17.csv", dataPointsSegmented, delimiter= ",")
    # np.savetxt("dataPointsSegmented_tomatosoup_trial5.csv", dataPointsSegmented, delimiter= ",")
    # np.savetxt("dataPointsSegmented_dominosugar_trial11.csv", dataPointsSegmented, delimiter= ",")
    # np.savetxt("dataPointsSegmented_pringles_trial2.csv", dataPointsSegmented, delimiter= ",")
    # np.savetxt("dataPointsSegmented_spamtuna_trial2.csv", dataPointsSegmented, delimiter= ",")
    np.savetxt("dataPointsSegmented_screwdriver_trial11.csv", dataPointsSegmented, delimiter= ",")
    

    # Saving the point cloud in the necessary format:
    # o3d.io.write_point_cloud("cheezit_trial17_segmented.ply", objectCloud)
    # o3d.io.write_point_cloud("tomatosoup_trial5_segmented.ply", objectCloud)
    # o3d.io.write_point_cloud("dominosugar_trial11_segmented.ply", objectCloud)
    # o3d.io.write_point_cloud("pringles_trial2_segmented.ply", objectCloud)
    # o3d.io.write_point_cloud("spamtuna_trial2_segmented.ply", objectCloud)
    o3d.io.write_point_cloud("screwdriver_trial11_segmented.ply", objectCloud)
    ...
    # np.savetxt('oriented_box_center_cheezit_trial10_semseg.csv', cloud_object.oriented_bounding_box_center, delimiter = ",")
    # np.savetxt('oriented_box_vertices_cheezit_trial10_semseg.csv', cloud_object.oriented_bounding_box_vertices, delimiter = ",")
    ...
    #np.savetxt('oriented_box_center_dominosugar_trial11_semseg.csv', cloud_object.oriented_bounding_box_center, delimiter = ",")
    #np.savetxt('oriented_box_vertices_dominosugar_trial11_semseg.csv', cloud_object.oriented_bounding_box_vertices, delimiter = ",")

    # np.savetxt('oriented_box_center_pringles_trial2_semseg.csv', cloud_object.oriented_bounding_box_center, delimiter = ",")
    # np.savetxt('oriented_box_vertices_pringles_trial2_semseg.csv', cloud_object.oriented_bounding_box_vertices, delimiter = ",")

    # np.savetxt('oriented_box_center_spamtuna_trial2.csv', cloud_object.oriented_bounding_box_center, delimiter = ",")
    # np.savetxt('oriented_box_vertices_spamtuna_trial2.csv', cloud_object.oriented_bounding_box_vertices, delimiter = ",")

    np.savetxt('oriented_box_center_screwdriver_trial11_semseg.csv', cloud_object.oriented_bounding_box_center, delimiter = ",")
    np.savetxt('oriented_box_vertices_screwdriver_trial11_semseg.csv', cloud_object.oriented_bounding_box_vertices, delimiter = ",")

    # np.savetxt('aligned_box_center_cheezit_trial10_semseg.csv', cloud_object.aligned_bounding_box_center, delimiter = ",")
    # np.savetxt('aligned_box_vertices_cheezit_trial10_semseg.csv', cloud_object.aligned_bounding_box_vertices, delimiter = ",")
    ...
    # np.savetxt('aligned_box_center_dominosugar_trial11_semseg.csv', cloud_object.aligned_bounding_box_center, delimiter = ",")
    # np.savetxt('aligned_box_vertices_dominosugar_trial11_semseg.csv', cloud_object.aligned_bounding_box_vertices, delimiter = ",")

    # np.savetxt('aligned_box_center_pringles_trial2_semseg.csv', cloud_object.aligned_bounding_box_center, delimiter = ",")
    # np.savetxt('aligned_box_vertices_pringles_trial2_semseg.csv', cloud_object.aligned_bounding_box_vertices, delimiter = ",")

    # np.savetxt('aligned_box_center_spamtuna_trial2.csv', cloud_object.aligned_bounding_box_center, delimiter = ",")
    # np.savetxt('aligned_box_vertices_spamtuna_trial2.csv', cloud_object.aligned_bounding_box_vertices, delimiter = ",")

    np.savetxt('aligned_box_center_screwdriver_trial11_semseg.csv', cloud_object.aligned_bounding_box_center, delimiter = ",")
    np.savetxt('aligned_box_vertices_screwdriver_trial11_semseg.csv', cloud_object.aligned_bounding_box_vertices, delimiter = ",")

    # Saving the processed point cloud: 
    # o3d.io.write_point_cloud("cheezit_trial10_Processed_Transformed_segmented.ply", cloud_object.processed_cloud)
    # o3d.io.write_point_cloud("tomatosoup_trial5_Processed_Transformed_segmented.ply", cloud_object.processed_cloud)
    # o3d.io.write_point_cloud("dominosugar_trial11_Processed_Transformed_segmented.ply", cloud_object.processed_cloud)
    # o3d.io.write_point_cloud("pringles_trial2_Processed_Transformed_segmented.ply", cloud_object.processed_cloud)
    # o3d.io.write_point_cloud("spamtuna_trial2_Processed_Transformed_segmented.ply", cloud_object.processed_cloud)
    o3d.io.write_point_cloud("screwdriver_trial11_Processed_Transformed_segmented.ply", cloud_object.processed_cloud)
